...
var agentsExamples = []ExampleDefinition{
	...
	{
		Name:                         "02_agents_providers_openai_step01_running",
		ProjectPath:                  "examples/02-agents/providers/openai/step01_running",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		ExpectedOutputDescription: []string{
			"The output should contain a joke about a pirate.",
			"The output should not contain error messages or stack traces.",
		},
	...
	{
		Name:                         "02_agents_providers_openai_step02_reasoning",
		ProjectPath:                  "examples/02-agents/providers/openai/step02_reasoning",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		MustContain:                  []string{"1. Non-streaming:", "Token usage:", "2. Streaming"},
		ExpectedOutputDescription: []string{
			"The non-streaming output should solve the train travel problem and include a reasoning summary.",
			"The streaming output should explain the theory of relativity in simple terms.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
		Name:                         "02_agents_providers_openai_step03_create_from_chat_client",
		ProjectPath:                  "examples/02-agents/providers/openai/step03_create_from_chat_client",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		ExpectedOutputDescription: []string{
			"The output should contain two pirate jokes from an agent explicitly backed by OpenAI Chat Completions, one non-streaming and one streaming.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
		Name:                         "02_agents_providers_openai_step04_create_from_openai_response_client",
		ProjectPath:                  "examples/02-agents/providers/openai/step04_create_from_openai_response_client",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		ExpectedOutputDescription: []string{
			"The output should contain two pirate jokes from an agent explicitly backed by OpenAI Responses, one non-streaming and one streaming.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
		Name:                         "02_agents_providers_openai_step05_conversation",
		ProjectPath:                  "examples/02-agents/providers/openai/step05_conversation",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		MustContain:                  []string{"=== Multi-turn Conversation Demo ===", "Full Conversation History:", "Conversation deleted."},
		ExpectedOutputDescription: []string{
			"The assistant should identify Paris, discuss landmarks there, and answer a contextual follow-up about the height of a famous landmark.",
			"The output should list the stored OpenAI conversation messages and confirm that the conversation was deleted.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
		Name:                         "02_agents_providers_openai_step06_code_interpreter_file_download",
		ProjectPath:                  "examples/02-agents/providers/openai/step06_code_interpreter_file_download",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		MustContain: []string{
			"Downloading container file:",
			"Container ID:",
			"File ID:",
			"Saved to:",
		},
		ExpectedOutputDescription: []string{
			"The output should show Code Interpreter generating a CSV multiplication table and downloading it through the OpenAI Containers API.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
		Name:                         "02_agents_providers_openai_chat_completion",
		ProjectPath:                  "examples/02-agents/providers/openai/chat_completion",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		ExpectedOutputDescription: []string{
			"The output should contain a joke about a pirate from an agent backed by OpenAI Chat Completions.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
		Name:                         "02_agents_providers_openai_responses",
		ProjectPath:                  "examples/02-agents/providers/openai/responses",
		RequiredEnvironmentVariables: []string{"OPENAI_API_KEY"},
		OptionalEnvironmentVariables: []string{"OPENAI_CHAT_MODEL_NAME"},
		ExpectedOutputDescription: []string{
			"The output should contain a joke about a pirate from an agent backed by OpenAI Responses.",
			"The output should not contain error messages or stack traces.",
		},
	},
	{
