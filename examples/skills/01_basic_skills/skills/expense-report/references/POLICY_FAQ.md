...
A: The $75/person limit applies as a guideline. Overages up to 20% are accepted with a written justification (for example, "client dinner at venue chosen by client"). Overages beyond 20% require pre-approval from your VP.
...
**Q: What if the $250/night limit is not enough for the city I am visiting?**
A: For high-cost cities (New York, San Francisco, London, Tokyo, Sydney), the limit is automatically increased to $350/night. No additional approval is needed. For other locations where rates are unusually high (for example, during a major conference), request a per-trip exception from your manager before booking.
...
**Q: My receipt is faded or damaged. What do I do?**
A: Try to obtain a duplicate from the vendor. If not possible, submit a Lost Receipt Affidavit (available from the Finance SharePoint site). You are limited to 2 affidavits per quarter.
