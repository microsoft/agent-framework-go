...
func TestInMemory_PersistsAndLoadsHistory(t *testing.T) {
	...
	next := func(_ context.Context, messages []*message.Message, _ ...agentopt.Option) iter.Seq2[*message.ResponseUpdate, error] {
	...
	secondNext := func(_ context.Context, messages []*message.Message, _ ...agentopt.Option) iter.Seq2[*message.ResponseUpdate, error] {
...
func TestInMemory_PersistsIntermediateResultsOnError(t *testing.T) {
	...
	next := func(_ context.Context, _ []*message.Message, _ ...agentopt.Option) iter.Seq2[*message.ResponseUpdate, error] {
		return func(yield func(*message.ResponseUpdate, error) bool) {
	...
	replayNext := func(_ context.Context, messages []*message.Message, _ ...agentopt.Option) iter.Seq2[*message.ResponseUpdate, error] {
